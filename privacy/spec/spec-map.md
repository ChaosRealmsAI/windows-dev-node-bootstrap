...
| Read-only diagnosis | `scripts/windows/Get-WindowsDevNodeReport.ps1` |
| Scoped removal and restoration | `scripts/windows/Uninstall-WindowsDevNode.ps1` |
| Portable repository contract | `tests/static_contract.py` |
| PowerShell parser contract | `tests/Validate-Project.ps1` |
